...
class AudioEffectNoiseReduction_FD_F32 : public AudioFreqDomainBase_FD_F32   //AudioFreqDomainBase_FD_F32 is in Tympan_Library
{
  public:
    ...
    bool LR_enable(bool state = true) { LR_enabled = state; return LR_enabled;}
    ...
    // see below for _L and _R versions
...
class AudioEffectNoiseReduction_FD_F32_L : public AudioEffectNoiseReduction_FD_F32  // AudioFreqDomainBase_FD_F32   //AudioFreqDomainBase_FD_F32 is in Tympan_Library
{
  public:
    //constructor
    AudioEffectNoiseReduction_FD_F32_L(const AudioSettings_F32 &settings) : AudioEffectNoiseReduction_FD_F32(settings) {};

    //destructor...release all of the memory that has been allocated
    ~AudioEffectNoiseReduction_FD_F32_L(void) {
    }
...
class AudioEffectNoiseReduction_FD_F32_R : public AudioEffectNoiseReduction_FD_F32  // AudioFreqDomainBase_FD_F32   //AudioFreqDomainBase_FD_F32 is in Tympan_Library
{
  public:
    //constructor
    AudioEffectNoiseReduction_FD_F32_R(const AudioSettings_F32 &settings) : AudioEffectNoiseReduction_FD_F32(settings) {};

    //destructor...release all of the memory that has been allocated
    ~AudioEffectNoiseReduction_FD_F32_R(void) {
    }
...
void AudioEffectNoiseReduction_FD_F32_L::processAudioFD(float32_t *complex_2N_buffer, const int NFFT) {
...
//
//  We get our data from complex_2N_buffer and we put our results back into complex_2N_buffer
void AudioEffectNoiseReduction_FD_F32_R::processAudioFD(float32_t *complex_2N_buffer, const int NFFT) {
  if (ave_spectrum == NULL) return; //if the memory for the average has yet to be initialized, return early
  if (gains == NULL) return;  //if the memory for the gain has yet to be initialized, return early
  int N_2 = NFFT / 2 + 1;
  //float Hz_per_bin = sample_rate_Hz /((float)NFFT); //sample_rate_Hz is from the base class AudioFreqDomainBase_FD_F32
